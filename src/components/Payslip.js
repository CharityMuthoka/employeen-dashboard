...
const Payslip = ({ setActivePage, activePage }) => {
      ...
      <div className="flex w-full h-screen overflow-hidden">
        ...
        <div className="flex-1 flex flex-col h-full overflow-y-auto overflow-x-hidden bg-white z-10">
          ...
          <div className="flex flex-col gap-6 px-8 pt-[45px] pb-8 max-w-[calc(100vw-272px)] mt-[62px]">
            {/* Payslip Content after authentication */}
            <div className="flex flex-col justify-start items-start gap-6 w-full">
              ...
              <div className="flex rounded-lg border border-slate-100 h-10 bg-slate-50 overflow-hidden w-full">
                ...
                >
                  <div className={`text-xs text-neutral-900 ${activeTab === 'payslipHistory' ? 'font-semibold' : 'font-medium'}`}>
                    Payslip History
                  </div>
                </div>
                <div
                ...
                >
                  <div className={`text-xs text-neutral-900 ${activeTab === 'deductions' ? 'font-semibold' : 'font-medium'}`}>
                    Deductions
                  </div>
                </div>
              </div>
                      ...
                      <div className="flex flex-col justify-start items-center w-[150px]">
                        ...
                        <div className="flex flex-row justify-center items-center gap-3 p-4 border-b border-neutral-200 h-[100px] w-full">
                          <div className="text-xs text-green-600 font-medium">
                            <span className="text-xs text-gray-800">8h</span><br />
                            Ksh. 1000
                          </div>
                        </div>
                        <div className="flex flex-row justify-center items-center gap-3 p-4 border-b border-neutral-200 h-[100px] w-full">
                          <div className="text-xs text-green-600 font-medium">
                            <span className="text-xs text-gray-800">4h</span><br />
                            Ksh. 500
                          </div>
                        </div>
                        <div className="flex flex-row justify-center items-center gap-3 p-4 h-[100px] w-full">
        ...
        {/* Statement Modal - Now placed outside the authentication block */}
        <StatementModal
  ...
  return (
    <div className="flex w-full h-screen overflow-hidden">
      ...
      {/* Scrollable Content Area */}
      <div className="flex-1 flex flex-col h-full overflow-y-auto overflow-x-hidden bg-gray-50 z-10">
        {/* Fixed Header */}
        <div className="fixed top-0 left-[272px] flex justify-between items-center p-3 w-[calc(100vw-272px)] border-b border-gray-200 bg-white z-50">
          {/* Greeting */}
          <div className="flex flex-col gap-2 w-96">
              ...
              <div className="flex flex-col justify-between items-end pb-1 gap-3 w-[400px] h-[164px]">
                ...
                <div className="flex flex-col justify-start items-start gap-3 h-[116px] ml-8">
                  <div className="font-inter text-xs w-[355px] text-amber-800 text-opacity-100 leading-snug tracking-normal font-normal">
                    This page contains sensitive financial and payroll information that
                    requires additional security verification to protect your privacy.
                  </div>
