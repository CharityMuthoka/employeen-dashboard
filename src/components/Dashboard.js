...
{/* === card section === */}
<div className="relative flex justify-between items-center p-4 rounded-xl h-[150px] shadow-lg bg-[#0B1E35] text-white transition-transform duration-200 hover:-translate-y-1 hover:shadow-xl overflow-hidden">

 
{/* === Left Column: Logo, Profile Photo & Name === */}
<div className="flex flex-col items-center justify-start space-y-2">
  ...
  {/* === name section === */}
  <h3 className="font-semibold italic text-[11px]">{name}</h3>
</div>
  ...
  <div className="flex flex-col justify-between h-full ml-2">
    <div>
      <h2 className="text-[12px] font-bold leading-tight">{name}</h2>
      <p className="text-[9px] text-gray-300">{role}</p>
    </div>

    <div className="mt-1">
      <p className="text-[10px] text-gray-400 uppercase">Department</p>
      <p className="text-[9px] font-semibold text-white">{department}</p>
    </div>

    <div className="mt-1">
      <p className="text-[10px] text-gray-400 uppercase">Staff ID</p>
      <p className="text-[9px] font-semibold text-white">{staffId}</p>
    </div>

    {/* Valid Thru */}
    <div className="text-center mt-[2px] mb-4">
      
    </div>

    <div className="absolute bottom-2 left-1/2 transform -translate-x-[5%] text-center">
  ...
  {/* === Right Section: QR and NFC sections === */}
...
END:VCARD`}
    ...
    {/* NFC Icon */}
    <div className="mt-2 flex items-center justify-center w-6 h-6 rounded-full border border-blue-400 bg-[#102A49] hover:bg-blue-900 transition">
      <img
...
{/* Right Section: QR, NFC, and Three Dots */}
...
{/* NFC Icon 2  */}
<div className="mt-2 relative flex items-center justify-center w-6 h-6 rounded-full border border-blue-400 bg-[#102A49] hover:bg-blue-900 transition">
<img
  src="/images/nfc_card.png"
  alt="NFC"
  className="w-4.5 h-4.5 object-contain animate-pulse"
...
{/* Three Dots Menu */}
<div className="absolute top-1/2 left-full ml-2 -translate-y-1/2" ref={menuRef}>
  <button
    onClick={() => setIsMenuOpen((open) => !open)}
    className="w-6 h-6 flex items-center justify-center rounded-full hover:bg-gray-700 focus:outline-none"
    aria-label="Options"
  >
    {/* vertical dots icon */}
    <svg
